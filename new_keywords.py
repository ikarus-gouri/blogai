...
class KeywordExtractor:
    def __init__(self, similarity_threshold=0.6, uniqueness_threshold=0.4):
    ...
    def extract_new_keywords(self, text, assigned_category, top_n=15):
        ...
        bigrams = self._extract_ngrams(text, n=2, top_n=10)
        trigrams = self._extract_ngrams(text, n=3, top_n=5)
        
        candidates = candidate_words + bigrams + trigrams
        ...
        for candidate in candidates:
            ...
            if is_unique and target_sim >= self.similarity_threshold:
                new_keywords.append({
                    "keyword": candidate,
        ...
        return {
            ...
            "unique_keywords_found": len(new_keywords)
        }
